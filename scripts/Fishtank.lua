...
-- Script start page
  ...
  rconsoleprint("| ~,  |  ")rconsoleprint("@@BLUE@@")rconsoleprint("<')))><")rconsoleprint("@@CYAN@@")rconsoleprint("~  ~~  ~~,~  ~ |  ~~ |   Made By: Salmon\n")
  rconsoleprint("|")rconsoleprint("@@BLUE@@")rconsoleprint("<'))X")rconsoleprint("@@CYAN@@")rconsoleprint("|~ ~~   ~, ~~   ")rconsoleprint("@@BLUE@@")rconsoleprint("<'>>><")rconsoleprint("@@CYAN@@")rconsoleprint("  ~|~   ~|   Type help to see commands\n")
  rconsoleprint("._____|_____")rconsoleprint("@@BLUE@@")rconsoleprint("<'}}}x")rconsoleprint("@@CYAN@@")rconsoleprint("_____________.~ ~~ |   \n")
  rconsoleprint(" `.~  |~ ~~   ~'   ~~~~,  ~  ~~ `.  ~|   \n")
